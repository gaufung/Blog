...
#pragma warning restore
{
    ...
    public static bool operator ==(Enumeration<TEnumeration> a, Enumeration<TEnumeration> b) => a is not null && b is not null && a.Key.Equals(b.Key, StringComparison.Ordinal);
